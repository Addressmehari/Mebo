...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "cue": MessageLookupByLibrary.simpleMessage("Deixa"),
    "cueDescription": MessageLookupByLibrary.simpleMessage(
      "é o gatilho que desencadeia o seu hábito. Pode ser uma hora específica, um local, um sentimento ou um evento.",
    ),
    ...
    "habitLoopDescription": MessageLookupByLibrary.simpleMessage(
      "O Ciclo do Hábito é um modelo psicológico que descreve o processo de formação de hábitos. Consiste em três elementos: Deixa, Rotina e Recompensa. A Deixa desencadeia a Rotina (uma ação habitual), que é reforçada pela Recompensa, criando um ciclo que torna o hábito mais enraizado e provável de ser repetido.",
    ),
